 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ZcoolWebViewActivity extends CommonFragmentActivity {
		...
		webview.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
				...
				case WebView.HitTestResult.IMAGE_TYPE:
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(ZcoolWebViewActivity.this);  
		               builder.setItems(new String[]{ZcoolWebViewActivity.this.getResources().getString(R.string.save_picture)}, new DialogInterface.OnClickListener() {  
		                   @Override  
		                   public void onClick(DialogInterface dialog, int which) {  
		                       new DownLoadAsyncTask(ZcoolWebViewActivity.this,imgurl).execute();  
		                   }  
		               });  
		               builder.show();  
					break;
...
//			}
	...
	public static void startZcoolWebViewActivity(Context context, String url) {
		Intent intent = new Intent();
		intent.putExtra("URL", url);
		intent.setClass(context, ZcoolWebViewActivity.class);
