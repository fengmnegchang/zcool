 ...
 ***************************************************************************************************************************************************************************** 
 */
public class IndexFocusPagerAdapter extends CommonPagerAdapter<IndexFocusBean> {

	public IndexFocusPagerAdapter(Context mContext, List<IndexFocusBean> list) {
		super(mContext, list);
	}

	@Override
	public Object instantiateItem(ViewGroup container, int position) {
		final IndexFocusBean bean = (IndexFocusBean) getItem(position);
