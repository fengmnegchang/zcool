 ...
 ***************************************************************************************************************************************************************************** 
 */
public class NewestCommentMainListAdapter extends CommonAdapter<IndexMainBean> {

	public NewestCommentMainListAdapter(Context mContext, List<IndexMainBean> list) {
		super(mContext, list);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_newest_comment_main_list, parent, false);
