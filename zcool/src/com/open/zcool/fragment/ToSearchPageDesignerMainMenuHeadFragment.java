...
import com.open.zcool.jsoup.ToSearchMainMenuHeadService;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ToSearchPageDesignerMainMenuHeadFragment extends SearchPostDropMenuHeadFragment {

	public static ToSearchPageDesignerMainMenuHeadFragment newInstance(WeakReferenceHandler sweakReferenceHandler, String url, boolean isVisibleToUser) {
		ToSearchPageDesignerMainMenuHeadFragment fragment = new ToSearchPageDesignerMainMenuHeadFragment();
	...
	public SearchPostJson call() throws Exception {
		...
		mSearchPostJson.setItems(ToSearchMainMenuHeadService.parseDesigner(url));
