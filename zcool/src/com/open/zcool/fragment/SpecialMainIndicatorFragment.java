 ...
 ***************************************************************************************************************************************************************************** 
 */
public class SpecialMainIndicatorFragment extends DesignerIndicatorFragment {

	public static SpecialMainIndicatorFragment newInstance(String url, boolean isVisibleToUser) {
		SpecialMainIndicatorFragment fragment = new SpecialMainIndicatorFragment();
	...
	public void onCallback(DesignerTabJson result) {
		...
		for (int i = 0; i < result.getList().size(); i++) {
			...
			if (i == 0) {
				fragment = SpecialMainPullListFragment.newInstance(bean.getHref(), true);
			} else {
				fragment = SpecialMainPullListFragment.newInstance(bean.getHref(), false);
			}
