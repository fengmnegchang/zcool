...
import com.open.zcool.jsoup.ArticleMainHeadDropService;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ArticlesMainMenuHeadFragment extends SearchPostDropMenuHeadFragment {

	public static ArticlesMainMenuHeadFragment newInstance(WeakReferenceHandler sweakReferenceHandler, String url, boolean isVisibleToUser) {
		ArticlesMainMenuHeadFragment fragment = new ArticlesMainMenuHeadFragment();
	...
	public SearchPostJson call() throws Exception {
		...
		mSearchPostJson.setItems(ArticleMainHeadDropService.parseSearchPost(url));
