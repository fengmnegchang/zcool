 ...
 * @createTime:2017-5-23上午10:49:01
 * @version:4.2.4
 * @modifyTime:
 * @modifyAuthor:
 * @description:
...
import com.open.zcool.fragment.SearchEnterpriseMainMenuHeadFragment;
import com.open.zcool.fragment.SearchPostDropMenuHeadFragment;
 ...
 *****************************************************************************************************************************************************************************
 */
public class MSearchWorksMenuHeadFragment extends SearchPostDropMenuHeadFragment {

	public static MSearchWorksMenuHeadFragment newInstance(WeakReferenceHandler sweakReferenceHandler, String url, boolean isVisibleToUser) {
		MSearchWorksMenuHeadFragment fragment = new MSearchWorksMenuHeadFragment();
	...
	public SearchPostJson call() throws Exception {
		...
		mSearchPostJson.setItems(SearchEnterpriseMainService.parseMSearchWorks(url));
