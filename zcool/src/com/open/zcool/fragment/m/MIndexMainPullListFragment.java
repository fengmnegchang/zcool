 ...
 *****************************************************************************************************************************************************************************
 */
public class MIndexMainPullListFragment extends IndexMainPullListFragment {
	public View headview;
	public static MIndexMainPullListFragment newInstance(String url, boolean isVisibleToUser) {
		MIndexMainPullListFragment fragment = new MIndexMainPullListFragment();
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		headview = LayoutInflater.from(getActivity()).inflate(R.layout.layout_m_index_head, null);
		return view;
	}
	...
	public void initValues() {
		...
		getChildFragmentManager().beginTransaction().replace(R.id.id_m_index_head, fragment).commit();
