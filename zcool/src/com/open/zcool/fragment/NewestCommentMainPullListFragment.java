...
import com.open.zcool.adapter.NewestCommentMainListAdapter;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class NewestCommentMainPullListFragment extends IndexMainPullListFragment {
//	private View headview;
	public NewestCommentMainListAdapter mIndexMainListAdapter;
	public static NewestCommentMainPullListFragment newInstance(String url, boolean isVisibleToUser) {
		NewestCommentMainPullListFragment fragment = new NewestCommentMainPullListFragment();
...
//		getChildFragmentManager().beginTransaction().replace(R.id.id_search_post_head, hfragment).commit();
		...
		mIndexMainListAdapter = new NewestCommentMainListAdapter(getActivity(), list);
	...
	public IndexMainJson call() throws Exception {
		...
		mIndexMainJson.setList(IndexMainListService.parseNewestMain(url, pageNo));
