 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ToSearchMainMenuHeadFragment extends SearchPostDropMenuHeadFragment {

	public static ToSearchMainMenuHeadFragment newInstance(WeakReferenceHandler sweakReferenceHandler, String url, boolean isVisibleToUser) {
		ToSearchMainMenuHeadFragment fragment = new ToSearchMainMenuHeadFragment();
	...
	public SearchPostJson call() throws Exception {
		...
		mSearchPostJson.setItems(ToSearchMainMenuHeadService.parseSearchPost(url));
