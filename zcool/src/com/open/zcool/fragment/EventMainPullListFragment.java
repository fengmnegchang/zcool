 ...
 ***************************************************************************************************************************************************************************** 
 */
public class EventMainPullListFragment extends IndexMainPullListFragment {
//	private View headview;

	public static EventMainPullListFragment newInstance(String url, boolean isVisibleToUser) {
		EventMainPullListFragment fragment = new EventMainPullListFragment();
...
//		getChildFragmentManager().beginTransaction().replace(R.id.id_search_post_head, hfragment).commit();
	...
	public IndexMainJson call() throws Exception {
		...
		mIndexMainJson.setList(IndexMainListService.parseEventMain(url, pageNo));
