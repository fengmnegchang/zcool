 ...
 ***************************************************************************************************************************************************************************** 
 */
public class NewestCommentMainIndicatorFragment extends DesignerIndicatorFragment {

	public static NewestCommentMainIndicatorFragment newInstance(String url, boolean isVisibleToUser) {
		NewestCommentMainIndicatorFragment fragment = new NewestCommentMainIndicatorFragment();
	...
	public void onCallback(DesignerTabJson result) {
		...
		for (int i = 0; i < result.getList().size(); i++) {
			...
			if (i == 0) {
				fragment = NewestCommentMainPullListFragment.newInstance(bean.getHref(), true);
			} else {
				fragment = NewestCommentMainPullListFragment.newInstance(bean.getHref(), false);
			}
