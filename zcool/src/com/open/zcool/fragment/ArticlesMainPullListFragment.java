 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ArticlesMainPullListFragment extends IndexMainPullListFragment {
	private View headview;

	public static ArticlesMainPullListFragment newInstance(String url, boolean isVisibleToUser) {
		ArticlesMainPullListFragment fragment = new ArticlesMainPullListFragment();
	...
	public void initValues() {
		...
		Fragment hfragment = ArticlesMainMenuHeadFragment.newInstance(weakReferenceHandler, url, true);
	...
	public IndexMainJson call() throws Exception {
		...
		mIndexMainJson.setList(IndexMainListService.parseArticleMain(url, pageNo));
